...
class Bill_App:
    def __init__(self, root):
        ...
        bg_color = "#96B6C5"
        title = Label(self.root, text="Billing System", font=('times new roman', 30, 'bold'), pady=2, bd=12, bg="#fff", fg="Black")
        title.pack(fill=X)
    # ================variables=======================
    ...
    # =============customer retail details======================
        F1 = LabelFrame(self.root, text="Customer Details", font=('times new roman', 15, 'bold'),bd=3, fg="#35A29F", bg="#fff")
        F1.place(x=0, y=80, relwidth=1)
        cname_lbl = Label(F1, text="Customer Name:",bg='white', font=('times new roman', 15, 'bold'),fg='red')
        cname_lbl.grid(row=0, column=0, padx=20, pady=5)
        cname_txt = Entry(F1, width=15, textvariable=self.c_name, font='arial 15', bd=7, relief=GROOVE)
        cname_txt.grid(row=0, column=1, pady=5, padx=10)

        cphn_lbl = Label(F1, text="Customer Phone:", bg='white', font=('times new roman', 15, 'bold'),fg='red')
        ...
        c_bill_lbl = Label(F1, text="Bill Number:", bg='white', font=('times new roman', 15, 'bold'),fg='red')
    ...
    # ===================Medical====================================
        F2 = LabelFrame(self.root, text="Medical Purpose", font=('times new roman', 15, 'bold'), bd=3, fg="#35A29F", bg="#fff")
        F2.place(x=5, y=180, width=325, height=380)

        sanitizer_lbl = Label(F2, text="Sanitizer", font=('times new roman', 16, 'bold'), bg="#fff", fg="red")
        ...
        mask_lbl = Label(F2, text="Mask", font=('times new roman', 16, 'bold'), bg="#fff", fg="red")
        ...
        hand_gloves_lbl = Label(F2, text="Hand Gloves", font=('times new roman', 16, 'bold'), bg="#fff", fg="red")
        ...
        dettol_lbl = Label(F2, text="Dettol", font=('times new roman', 16, 'bold'), bg="#fff", fg="red")
        ...
        newsprin_lbl = Label(F2, text="Newsprin", font =('times new roman', 16, 'bold'), bg= "#fff", fg= "red")
        ...
        thermal_gun_lbl = Label(F2, text="Thermal Gun", font=('times new roman', 16, 'bold'), bg="#fff", fg="red")
    ...
    # ==========GroceryItems=========================
        F3 = LabelFrame(self.root, text="Grocery Items", font=('times new roman', 15, 'bold'), bd=3, fg="#35A29F", bg="#fff")
        F3.place(x=340, y=180, width=325, height=380)

        rice_lbl = Label(F3, text="Rice", font=('times new roman', 16, 'bold'), bg="#fff", fg="red")
        ...
        food_oil_lbl = Label(F3, text="Food Oil", font=('times new roman', 16, 'bold'), bg="#fff", fg="red")
        ...
        wheat_lbl = Label(F3, text="Wheat", font=('times new roman', 16, 'bold'), bg="#fff", fg="red")
        ...
        daal_lbl = Label(F3, text="Daal", font=('times new roman', 16, 'bold'), bg="#fff", fg="red")
        ...
        flour_lbl = Label(F3, text="Flour", font=('times new roman', 16, 'bold'), bg="#fff", fg="red")
        ...
        maggi_lbl = Label(F3, text="Maggi", font=('times new roman', 16, 'bold'), bg="#fff", fg="red")
    ...
    # ===========ColdDrinks================================
        F4 = LabelFrame(self.root, text="Cold Drinks", font=('times new roman', 15, 'bold'), bd=3, fg="#35A29F", bg="#fff")
        F4.place(x=670, y=180, width=325, height=380)

        sprite_lbl = Label(F4, text="Sprite", font=('times new roman', 16, 'bold'), bg="#fff", fg="red")
        ...
        limka_lbl = Label(F4, text="Limka", font=('times new roman', 16, 'bold'), bg="#fff", fg="red")
        ...
        mazza_lbl = Label(F4, text="Mazza", font=('times new roman', 16, 'bold'), bg="#fff", fg="red")
        ...
        coke_lbl = Label(F4, text="Coke", font=('times new roman', 16, 'bold'), bg="#fff", fg="red")
        ...
        fanta_lbl = Label(F4, text="Fanta", font=('times new roman', 16, 'bold'), bg="#fff", fg="red")
        ...
        mountain_duo_lbl = Label(F4, text="Mountain Duo", font=('times new roman', 16, 'bold'),bg="#fff", fg="red")
    ...
    # =======================ButtonFrame=============
        F6 = LabelFrame(self.root, text="Bill Area", font=('times new roman', 14, 'bold'), bd=3, fg="#35A29F", bg="#fff")
        F6.place(x=0, y=560, relwidth=1, height=140)

        m1_lbl = Label(F6, text="Total Medical Price", font=('times new roman', 14, 'bold'),bg="#fff", fg="red")
        ...
        m2_lbl = Label(F6, text="Total Grocery Price", font=('times new roman', 14, 'bold'), bg="#fff", fg="red")
        ...
        m3_lbl = Label(F6, text="Total Cold Drinks Price", font=('times new roman', 14, 'bold'), bg="#fff", fg="red")
        ...
        m4_lbl = Label(F6, text="Medical Tax", font=('times new roman', 14, 'bold'), bg="#fff", fg="red")
        ...
        m5_lbl = Label(F6, text="Grocery Tax", font=('times new roman', 14, 'bold'), bg="#fff", fg="red")
        ...
        m6_lbl = Label(F6, text="Cold Drinks Tax", font=('times new roman', 14, 'bold'), bg="#fff", fg="red")
...
#================totalBill==========================
    def total(self):
        ...
        self.medical_price.set("LE. "+str(self.total_medical_price))
        self.c_tax = round((self.total_medical_price*0.05), 2)
        self.medical_tax.set("LE. "+str(self.c_tax))
        ...
        self.grocery_price.set("LE. " + str(self.total_grocery_price))
        self.g_tax = round((self.total_grocery_price*5), 2)
        self.grocery_tax.set("LE. " + str(self.g_tax))
        ...
        self.cold_drinks_price.set("LE. "+str(self.total_cold_drinks_price))
        self.c_d_tax = round((self.total_cold_drinks_price * 0.1), 2)
        self.cold_drinks_tax.set("LE. "+str(self.c_d_tax))
...
#==============welcome-bill==============================
    def welcome_bill(self):
        ...
        self.txtarea.insert(END, "\t\tBill Details")
...
#=========billArea=================================================
    def bill_area(self):
        if self.c_name.get() == " " or self.c_phone.get() == " ":
            messagebox.showeinfo("Error", "Customer Details Are Must")
